<template>
	...
	>
		...
		<v-row align="center" class="mb-2">
			...
			<v-col class="py-0">
				<v-text-field v-model="userDetailInfo.userNm" dense hide-details :disabled="isDisabled" class="my-0" clearable></v-text-field>
			</v-col>
		</v-row>
...
<script>
import { TheAddrEdit, FOutlinedBtn } from '@/assets/util/importFile.js'
...
export default {
	...
	// 		this.isNullAndEmpty(info.userPw) 	  === true ? info.userPw 	  = 'NONE' : this.userDetailInfo.userPw = 'NONE';
