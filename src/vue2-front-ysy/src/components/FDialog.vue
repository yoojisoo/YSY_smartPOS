...
<template>
	<v-row justify="center">
		...
		<v-dialog v-model="isDialog" persistent max-width="600">
			<v-card>
				<v-toolbar color="#6667AB" dark flat height="18"> </v-toolbar>
				...
				<v-card-actions>
					<v-spacer />
					<v-btn color="#6667AB" text @click="clickConfirm"> 확인 </v-btn>
				</v-card-actions>
			</v-card>
		</v-dialog>
	</v-row>
...
<script>
import dateForm from '@/components/FDateForm.vue';
